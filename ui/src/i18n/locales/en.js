export const enMessages = {
	...
	agentConfig: {
		title: 'Agent Config',
		tabs: { personality: 'Personality', memory: 'Memory', skills: 'Skills', tools: 'Tools' },
		personality: {
			agentName: 'Agent Name',
			tone: 'Tone',
			skills: 'Expertise',
			extra: 'Additional Notes',
			tones: { casual: 'Casual', professional: 'Professional', concise: 'Concise', humorous: 'Humorous' },
			userName: 'My Name',
			lang: 'Language Preference',
			userExtra: 'About Me',
			langs: { zh: '中文', en: 'English', auto: 'Auto' },
			save: 'Save',
			saveSuccess: 'Saved',
