<template>
	<main class="flex min-h-screen items-center justify-center bg-default px-4 py-8 pt-[max(2rem,var(--safe-area-inset-top))] pb-[max(2rem,var(--safe-area-inset-bottom))]">
